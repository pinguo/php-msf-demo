...
MAPPED_WEB_PORT=1234
MAPPED_TCP_PORT=9190
MAPPED_DISPATCH_PORT=9992
MAPPED_NEO4J_PORT=7475
...
CARGS=" -d -p $MAPPED_SSH_PORT:22 -p $MAPPED_NGINX_PORT80:80 -p $MAPPED_NGINX_PORT443:443 -p $MAPPED_WEB_PORT:1234 -p $MAPPED_TCP_PORT:9090 -p $MAPPED_DISPATCH_PORT:9991 -p $MAPPED_NEO4J_PORT:7474"
